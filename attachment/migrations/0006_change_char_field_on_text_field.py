...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('attachment_attachmentimage', 'title', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'AttachmentFile.title'
        db.alter_column('attachment_attachmentfile', 'title', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'AttachmentFile.title'
        db.alter_column('attachment_attachmentfile', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
