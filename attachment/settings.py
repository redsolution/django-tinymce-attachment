...
ATTACHMENT_MAX_IMAGE_UPLOAD_SIZE = getattr(settings, 'ATTACHMENT_MAX_IMAGE_UPLOAD_SIZE', None)
ATTACHMENT_MAX_FILE_UPLOAD_SIZE = getattr(settings, 'ATTACHMENT_MAX_FILE_UPLOAD_SIZE', None)

ATTACHMENT_IMAGE_ROLES = getattr(settings, 'ATTACHMENT_IMAGE_ROLES', False)